            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex">
                    <button @click="add" type="button" class="mb-2 btn btn-primary">
                        ...
                        Add New Home Setting
                    </button>
                </div>
                <div class="d-flex">
                    <div class="pr-1">
                        <select v-model="searchQueryKeys" class="form-control" placeholder="Choose by key">
                            <option value="" selected>All Keys</option>
                            <template v-for="(v) in homeSettingKeys" :key="v">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">
                        <span v-if="statusEditing">Edit Home Setting</span>
                        <span v-else>Add New Home Setting</span>
                    </h5>
                ...
                <Form ref="form" @submit="handleSubmit" :validation-schema="statusEditing ? editDataSchema : createDataSchema" v-slot="{ errors }" :initial-values="formValues">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <Field name="key" as="select" class="form-control" :class="{ 'is-invalid': errors.key }" id="key">
                        ...
                        <div class="form-group">
                            ...
                            <Field name="content" as="textarea" class="form-control" :class="{ 'is-invalid': errors.content }" id="content" aria-describedby="contentHelp" placeholder="Enter content" />
...
<script setup>
    ...
    import { homeSettingKeys } from "../../utils/constants";
    ...
    const getDatas = (page = 1) => {
        ...
        requestGet(`admin/home-settings`, queryParam)
        .then((RESPONSE) => {
    ...
    const createData = (values, { resetForm, setErrors }) => {
        ...
        requestPost('admin/home-settings/store', formData)
        .then((RESPONSE) => {
    ...
    const updateData = (values, { resetForm, setErrors }) => {
        ...
        requestPatch(`admin/home-settings/update/${formValues.value.id}`, { _method: 'PATCH'}, formData)
        .then((RESPONSE) => {
    ...
    const deleteData = () => {
        requestDelete(`admin/home-settings/destroy/${dataIdBeingDeleted.value}`)
        .then(() => {
